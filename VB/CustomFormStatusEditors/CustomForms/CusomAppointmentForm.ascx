<%@ Control Language="vb" AutoEventWireup="true" Inherits="CusomAppointmentForm" CodeBehind="CusomAppointmentForm.ascx.vb" %>
            ...
            <td class="dxscSingleCell">
                <table class="dxscLabelControlPair" <%=DevExpress.Web.Internal.RenderUtils.GetTableSpacings(Me, 0, 0)%>>
                    <tr>
                        ...
                        <td class="dxscControlCell">
                            <dx:ASPxComboBox ClientInstanceName="_dx" ID="edtLabel" runat="server" Width="100%" ValueType="System.Int32" ShowImageInEditBox="true"
                                DataSource='<%#CType(Container, AppointmentFormTemplateContainer).LabelDataSource%>' OnDataBound="edtLabel_DataBound">
                            </dx:ASPxComboBox>
                        </td>
                    </tr>
                </table>
            ...
            <td class="dxscSingleCell">
                <table class="dxscLabelControlPair" <%=DevExpress.Web.Internal.RenderUtils.GetTableSpacings(Me, 0, 0)%>>
                    <tr>
                        ...
                        <td class="dxscControlCell">
                            <dx:ASPxComboBox ClientInstanceName="_dx" ID="edtStatus" runat="server" Width="100%" ValueType="System.Int32"
                                DataSource='<%#CType(Container, AppointmentFormTemplateContainer).StatusDataSource%>' ShowImageInEditBox="true" OnDataBound="edtStatus_DataBound" />
                        </td>
                    </tr>
                </table>
            </td>
