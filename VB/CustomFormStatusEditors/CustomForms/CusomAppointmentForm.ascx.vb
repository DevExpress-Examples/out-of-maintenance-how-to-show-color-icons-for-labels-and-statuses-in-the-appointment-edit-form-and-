...
Partial Public Class CusomAppointmentForm
    ...
    Protected Sub edtLabel_DataBound(ByVal sender As Object, ByVal e As EventArgs)
        For Each item As ListEditItem In edtLabel.Items
            AssignImageUrl(item, "LabelImages")
        Next item
    End Sub

    Protected Sub edtStatus_DataBound(ByVal sender As Object, ByVal e As EventArgs)
        For Each item As ListEditItem In edtStatus.Items
            AssignImageUrl(item, "StatusImages")
        Next item
    End Sub
    Private Sub AssignImageUrl(ByVal item As ListEditItem, ByVal folderName As String)
        Dim imageUrl As String = String.Format("~/Images/{0}/{1}.png", folderName, item.Text)
