        ...
        <td class="dxscSingleCell">
            <table class="dxscLabelControlPair" <%=DevExpress.Web.Internal.RenderUtils.GetTableSpacings(Me, 0, 0)%>>
                <tr>
                    ...
                    <td class="dxscControlCell">
                        <dx:ASPxComboBox ClientInstanceName="_dx" ID="edtLabel" runat="server" Width="100%" ValueType="System.Int32" DataSource='<%#CType(Container, AppointmentFormTemplateContainer).LabelDataSource%>' />
                    </td>
                </tr>
            </table>
        </td>
        ...
        <td class="dxscSingleCell">
            <table class="dxscLabelControlPair" <%=DevExpress.Web.Internal.RenderUtils.GetTableSpacings(Me, 0, 0)%>>
                <tr>
                    ...
                    <td class="dxscControlCell">
                        <dx:ASPxComboBox ClientInstanceName="_dx" ID="edtStatus" runat="server" Width="100%" ValueType="System.Int32" DataSource='<%#CType(Container, AppointmentFormTemplateContainer).StatusDataSource%>' />
                    </td>
                </tr>
            </table>
        </td>
