<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="Default.aspx.vb" Inherits="CustomFormStatusEditors.Default" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxwschs:ASPxScheduler ID="ASPxScheduler1" runat="server" AppointmentDataSourceID="SqlDataSource1" ClientIDMode="AutoID" GroupType="Resource" OnBeforeExecuteCallbackCommand="ASPxScheduler1_BeforeExecuteCallbackCommand" ResourceDataSourceID="SqlDataSource2" Start="2016-02-10">
                <Storage>
