<%@ Control Language="C#" AutoEventWireup="true" Inherits="CusomAppointmentForm" CodeBehind="CusomAppointmentForm.ascx.cs" %>
                    ...
                    <tr>
                        ...
                        <td class="dxscControlCell">
                            <dx:ASPxComboBox ClientInstanceName="_dx" ID="edtLabel" runat="server" Width="100%" ValueType="System.Int32" ShowImageInEditBox="true"
                                DataSource='<%# ((AppointmentFormTemplateContainer)Container).LabelDataSource %>' OnDataBound="edtLabel_DataBound">
                            </dx:ASPxComboBox>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        ...
                        <td class="dxscControlCell">
                            <dx:ASPxComboBox ClientInstanceName="_dx" ID="edtStatus" runat="server" Width="100%" ValueType="System.Int32"
                                DataSource='<%# ((AppointmentFormTemplateContainer)Container).StatusDataSource %>' ShowImageInEditBox="true" OnDataBound="edtStatus_DataBound" />
                        </td>
                    </tr>
                </table>
            </td>
