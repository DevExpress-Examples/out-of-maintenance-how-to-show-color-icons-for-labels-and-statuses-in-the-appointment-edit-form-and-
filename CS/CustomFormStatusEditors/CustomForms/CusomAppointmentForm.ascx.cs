...
public partial class CusomAppointmentForm : SchedulerFormControl
{
    ...
    protected void edtLabel_DataBound(object sender, EventArgs e)
    {
        foreach(ListEditItem item in edtLabel.Items)
            AssignImageUrl(item, "LabelImages");
    }

    protected void edtStatus_DataBound(object sender, EventArgs e)
    {
        foreach (ListEditItem item in edtStatus.Items)
